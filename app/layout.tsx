...
const WhatsAppWidget = dynamic(() => import('@/components/Widgets/WhatsAppWidget'), {
  ssr: false
});
...
export const metadata: Metadata = {
  title: 'CityWitty - Your Premium City Card Platform',
  description: 'Get exclusive discounts and offers with CityWitty Card across your favorite merchants in the city.',
