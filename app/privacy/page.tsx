...
export const metadata: Metadata = {
    title: 'Privacy Policy - CityWitty Privilege Card Merchant Registration',
    description: 'Read the detailed Privacy Policy for merchants registering with CityWitty Privilege Card. Learn how we collect, use, and protect your information.',
};
