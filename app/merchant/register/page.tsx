      ...
      <div className="container py-5">
        <div className="text-center mb-5 pt-5">
          ...
          <p className="lead text-white opacity-90 mb-5">
            Join our network of premium merchants and grow your business with exclusive offers
          </p>
        </div>
              ...
              <div className="card border-0 shadow-lg" style={{
                ...
                <div className="card-body p-5 text-center">
                  <div className="mb-4">
                    ...
                    >
                      <i className="fas fa-store text-white" style={{ fontSize: '3rem' }}></i>
                    </div>
                  </div>
                  ...
                  <div className="row mb-5">
                    <div className="col-md-4 mb-4">
                      <div className="p-4">
                        ...
                        <p className="text-muted">Connect with thousands of CityWitty cardholders</p>
                      </div>
                    </div>
                    <div className="col-md-4 mb-4">
                      <div className="p-4">
                        ...
                        <p className="text-muted">Increase revenue with our exclusive offer platform</p>
                      </div>
                    </div>
                    <div className="col-md-4 mb-4">
                      <div className="p-4">
                        ...
                        <p className="text-muted">Join our verified network of premium merchants</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="alert alert-info border-0 mb-4" style={{
                    ...
                    <strong>Registration Process:</strong> Fill out our comprehensive form to join our premium merchant network
                  </div>
                  ...
                  <div className="mt-4">
                    <small className="text-muted">
                      ...
                      Your information is secure and will be reviewed within 3-5 business days
                    </small>
                  </div>
                </div>
              </div>
              ...
              <div className="card border-0 shadow-lg" style={{
                ...
                <div className="card-body p-5">
                  <div className="alert alert-warning border-0 mb-4" style={{
                    background: 'linear-gradient(135deg, rgba(255, 193, 7, 0.1) 0%, rgba(255, 145, 77, 0.1) 100%)',
                    borderRadius: '15px'
                  }}>
                    <i className="fas fa-exclamation-triangle me-2"></i>
                    <strong>Form Preview Mode:</strong> This form is currently disabled. Use the "Register as Merchant" button above to access the live registration form.
                  </div>
                  ...
                  <form style={{ opacity: 0.6, pointerEvents: 'none' }}>
                    <div className="row">
                      <div className="col-md-6 mb-3">
                        ...
                        <input type="text" className="form-control" placeholder="Enter owner's full name" disabled />
                      </div>
                      <div className="col-md-6 mb-3">
                        <label className="form-label fw-bold">
                          <i className="fas fa-store me-2"></i>Store Name *
                        </label>
                        <input type="text" className="form-control" placeholder="Enter store/business name" disabled />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-6 mb-3">
                        ...
                        <input type="email" className="form-control" placeholder="business@example.com" disabled />
                      </div>
                      <div className="col-md-6 mb-3">
                        <label className="form-label fw-bold">
                          <i className="fas fa-phone me-2"></i>Phone Number *
                        </label>
                        <input type="tel" className="form-control" placeholder="+91 9876543210" disabled />
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      ...
                      <textarea className="form-control" rows={3} placeholder="Enter complete business address" disabled></textarea>
                    </div>
                    ...
                    <div className="mb-3">
                      ...
                      <textarea className="form-control" rows={4} placeholder="Describe your exclusive offer for CityWitty cardholders" disabled></textarea>
                    </div>
                  </form>
